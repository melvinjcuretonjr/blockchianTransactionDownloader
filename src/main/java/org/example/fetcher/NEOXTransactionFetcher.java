...
public class NEOXTransactionFetcher extends TransactionFetcher{

    private static final String NEOX_EXPLORER_URL = "https://explorer.neoxa.net/ext/getaddresstxs/";
    private static final String ENDING = "/0/1000";

    public NEOXTransactionFetcher(String neoxAddress) {
        super(neoxAddress);
    }
    ...
    public List<TransactionData> fetchTransactions() throws Exception {
        ...
        String url = NEOX_EXPLORER_URL + address + ENDING;
        ...
        for (int i = 0; i < transactions.length(); i++) {
           ...
           TransactionData transactionData = new TransactionData("neox", transactionId, timestamp, amount, BigDecimal.ZERO);
